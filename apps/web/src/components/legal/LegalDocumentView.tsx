        ...
        {isAR && (
          <div className="mt-4 rounded-2xl border border-[var(--jt-gold-300)]/60 bg-[var(--jt-gold-100)]/40 p-4">
            <p className="text-sm text-[var(--jt-stone-800)]" style={{ fontFamily: 'var(--jt-font-arabic)', lineHeight: 1.95 }}>
              النصّ العربي الكامل لهذه الوثيقة أدناه هو مسوّدة أوّلية، لا تزال قيد المراجعة القانونية النهائية قبل اعتمادها
              رسميًا. حتى اكتمال تلك المراجعة، لا يُعتبر هذا النصّ نسخة رسمية مُلزِمة.
            </p>
          </div>
        )}
      </section>
